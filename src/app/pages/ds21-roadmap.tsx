...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "p1-3", text: "Table port → Lit (ds-table, server-side pagination)", owner: "dev", effort: "L", status: "completed" },
  ...
  },
  {
    ...
    duration: "~3 สัปดาห์",
    tasks: [
      { id: "p2-1", text: "Dropdown upgrade → ds-dropdown (multi-select, search)", owner: "dev", effort: "M", status: "completed" },
      { id: "p2-2", text: "Calendar / DatePicker upgrade → ds-calendar + ds-time-picker", owner: "dev", effort: "M", status: "completed" },
      { id: "p2-3", text: "Table upgrade → ds-table (sort, selection, bulk action)", owner: "dev", effort: "M", status: "completed" },
      { id: "p2-4", text: "Sidebar upgrade → ds-sidebar + ds-top-navbar", owner: "dev", effort: "S", status: "completed" },
      { id: "p2-5", text: "Charts port → ds-line-chart / ds-bar-chart / ds-donut-chart (zero-dep SVG)", owner: "dev", effort: "L", status: "completed" },
  ...
  },
  {
    ...
    duration: "~3 สัปดาห์",
    tasks: [
      { id: "p3-1", text: "AppShell provider → ds-app-shell-provider (brand token injection)", owner: "dev", effort: "L", status: "completed" },
      { id: "p3-2", text: "AppShell layout → ds-app-shell (slot-based Navbar + Sidebar + Content)", owner: "dev", effort: "M", status: "completed" },
