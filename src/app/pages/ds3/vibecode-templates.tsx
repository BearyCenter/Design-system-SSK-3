...
ขอ HTML พร้อมใช้เลย`,
    description: "Starting point สำหรับ feature ใหม่ — AppShell + Sidebar + PageHeader",
    html: `<ssk-app-shell-provider brand="ccs3">
...
ขอ HTML AppShell พร้อมใช้`,
    description: "List page — AppShell + FilterBar + Table + Pagination",
    html: `<ssk-app-shell-provider brand="ccs3">
...
ขอ HTML AppShell พร้อมใช้`,
    description: "Create/Edit form — AppShell + Card + Validation Alert",
    html: `<ssk-app-shell-provider brand="ccs3">
  <ssk-page-header title="Create Order">
    <ssk-button slot="action" variant="outline">Cancel</ssk-button>
  </ssk-page-header>
  <div style="padding: 24px; display: flex; flex-direction: column; gap: 16px;">
    <ssk-alert themeColor="danger" id="error-alert" style="display:none;">
