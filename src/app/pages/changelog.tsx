...
export const changelogVersions: ChangelogVersion[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: <Paintbrush size={16} />, title: "Multi-Brand Theming", description: "ssk-theme-provider injects both semantic tokens and --ssk-colors-* primitive CSS variables via Shadow DOM. Supports patona, ccs3, and oc2plus brand identities." },
      ...
      { icon: <Navigation size={16} />, title: "AppShell Layout", description: "ssk-app-shell provides a responsive grid layout shell. ssk-app-shell-provider injects brand tokens globally. ds-feature-page-scaffold wraps page content with consistent padding and header." },
